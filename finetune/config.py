...
class Config:
    ...
    def __init__(self):
        ...
        self.test_time_range = ["2024-04-01", "2026-04-17"]
        self.backtest_time_range = ["2025-07-01", "2026-04-17"]
        ...
        self.epochs = 30
        self.log_interval = 10  # Log training status every N batches (reduced for better progress visibility)
        self.batch_size = 16  # Reduced batch size for laptop GPU memory
        # self.batch_size = 50  # Original batch size for larger GPUs
        ...
        # Reduced for faster iteration on laptops
        self.n_train_iter = 500 * self.batch_size
        self.n_val_iter = 100 * self.batch_size
        # self.n_train_iter = 2000 * self.batch_size  # Original
        # self.n_val_iter = 400 * self.batch_size  # Original
        ...
        # Use Hugging Face Hub pre-trained models directly
        self.pretrained_tokenizer_path = "NeoQuasar/Kronos-Tokenizer-base"
        self.pretrained_predictor_path = "NeoQuasar/Kronos-small"  # Use small model for faster fine-tuning on laptop
        # For better quality use base model: "NeoQuasar/Kronos-base" (102M parameters)
