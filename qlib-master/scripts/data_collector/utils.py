...
# Direct import from source file since pip version doesn't have pickle_utils
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PICKLE_UTILS_PATH = os.path.abspath(os.path.join(SCRIPT_DIR, "../../qlib/utils/pickle_utils.py"))

# Execute the file directly to get restricted_pickle_load
with open(PICKLE_UTILS_PATH, 'r', encoding='utf-8') as f:
    code = compile(f.read(), PICKLE_UTILS_PATH, 'exec')
    ns = {}
    exec(code, ns)
restricted_pickle_load = ns['restricted_pickle_load']
